Feature: Mark single file as published
  ...
  Scenario: The one where marking the state as published is successful - service account
  ...
  Scenario: The one where marking the state as published is successful - user account
  ...
  Scenario: The one where the user does not have permission to mark a file as published
