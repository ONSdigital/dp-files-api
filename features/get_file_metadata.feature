Feature: Fetching metadata for a file
  ...
  Scenario: The file metadata includes previous series and edition IDs after content item is updated
    ...
    When I update the content item of the file "images/meme.jpg" with:
      ...
      """
    And the file metadata is requested for the file "images/meme.jpg"
    Then I should receive the following JSON response with status "200":
    """
    {
      "path": "images/meme.jpg",
